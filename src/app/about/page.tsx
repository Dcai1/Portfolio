      ...
      >
        ...
        >
          ...
          <ul className="space-y-2 text-lg text-gray-300 list-disc list-inside sm:text-xl">
            <li>
              When I&apos;m deep into coding sessions, I get too engaged (to the
              point I forget to eat or use the washroom) until I achieve the
              end-goal.
            </li>
            <li>
              I love building community levels on game editors in my free time.
            </li>
            <li>
              Outside of coding, I enjoy playing video games that are Story or
              RPG.
            </li>
          </ul>
        </motion.div>
